        ...
        <header class="bg-slate-900 text-white shadow-md relative z-20">
            <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
                <h1 class="text-lg font-bold flex items-center gap-2 cursor-pointer" @click="currentView = 'dashboard'">
                    ...
                    <span style="color: #C97D26;">微風台中</span>
                </h1>
                <div>
                ...
                <div class="max-w-7xl mx-auto px-4 py-6 flex-1 w-full space-y-6">
                    ...
                    <template v-if="currentView === 'dashboard'">
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-4 border border-slate-100 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 items-end">
                            <div>
                                <label class="block text-xs font-bold text-slate-600 mb-1">🔍 關鍵字</label>
                                <input v-model="filters.keyword" @input="fetchAttractions(1)" type="text" placeholder="搜尋名稱、地址..." class="w-full p-2 text-xs border rounded-md bg-white">
                            </div>
                            <div>
                            ...
                            <div>
                                <label class="block text-xs font-bold text-slate-600 mb-1">🏷️ 主題分類</label>
